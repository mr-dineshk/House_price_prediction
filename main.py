...
app = Flask(__name__)
data = pd.read_csv('C:\\Users\\Dinesh kumar\\Documents\\Program\\Online_intenship\\Bharat_intern\\HousePrice_Prediction\\final_dataset.csv')
pipe = pickle.load(open("C:\\Users\\Dinesh kumar\\Documents\\Program\\Online_intenship\\Bharat_intern\\HousePrice_Prediction\\RidgeModel.pkl", 'rb'))
